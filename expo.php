...
<script>
  ...
  gtag('config', 'UA-113907534-1');
        ...
        <meta name="keywords" content="E-cell VNIT entreprenuship cell consortium 18 startup expo ecell vnit consortium startup expo vnit " />
    ...
    <body>
            ...
            <div class="card" id="event-card-bg">
    		    <div class="card-tabs">
    		      <ul class="tabs tabs-fixed-width">
    		        <li class="tab"><a class="active" href="#bizmantra4">DETAILS</a></li>
    		        <li class="tab"><a href="#bizmantra5">OPPORTUNITIES</a></li>
    		      </ul>
    		    </div>
    		    <div class="card-content code">
    		    	<div id="bizmantra4">
                        <h6><b>Date :- 9th March, 2018 – 11th March, 2018 </b></h6>
                        ...
                        <ul>
                            ...
                            <li>Best Minds</li>
                            <li>Technological Enthusiasts</li>
                            <li>Upcoming Engineers</li>
    		    	...
    		    	<div id="bizmantra5">
                        <h6>E-Cell, VNIT Nagpur presents <b>Startup-Expo</b></h6>
                        <h6>an event to showcase your entrepreneurial and business bravura, under the aegis of Consortium'18 - The Annual E-summit of VNIT.</h6>
                        <br>
                        <h6><b>Opportunities with us :-</b></h6>
    			     	<ol>
    			     	    <li>A chance to present your ideas afront venerable angel investors, technocrats,mentors and business houses who will be a part of Consortium'18.</li>
    			     	    <li>IIM Nagpur in the premises of VNIT- a blend of management and technical avenues to present your ideas and expand your enterprises.</li>
    			     	    <li>Seek authentic feedbacks and reviews from the right people.</li>
    			     	    <li>A productive environment to propagate the lustre of your ideas and grandly publicise.</li>
    			     	    <li>Behold an opportunity to brand your ideas in one of Central India's largest E-summit.</li>
    			     	    <li>Get acknowledged with a certificate from E-Cell VNIT according your distinct presence in Startup Expo.</li>
    			     	</ol>
    			     	<br>
        ...
        <div class="container js__parallax-window">
            <div class="" id="cordinator">
                <h2 class="g-font-size-40--xs g-font-size-50--sm g-font-size-40--md g-color--white">Contact Us</h2>
                <ol class="row">
                    <li class="col-md-6 g-color--white">
                        <h6 class="g-color--white g-font-size-20--md">Utkarsh Gupta</h6>
                        <p class=" g-color--white">vnitutkrshgpta@gmail.com</p>
            ...
            <div id="newform">
                <form class="g-bg-color--dark-light g-padding-x-50--xs g-padding-y-80--xs g-radius--4">
                    <div class="g-text-center--xs">
                        <a href="https://expo.ecellvnit.org/register/" target="_blank" class="text-uppercase btn-block s-btn s-btn--md s-btn--white-bg g-radius--50 g-padding-x-50--xs g-margin-b-20--xs">Register</a>
                    </div>
                </form>
            </div>
        </div>
